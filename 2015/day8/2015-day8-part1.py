...
def processStrings():
    ...
    for stringItem in stringsList:
        ...
        if debug:
            print(stringItem,len(stringItem),(len(eval(stringItem))))
    
    if debug:
        print("codeCharacters:",codeCharacters,"memoryCharacters:",memoryCharacters)
...
(codeCharacters, memoryCharacters) = processStrings()

answer = codeCharacters - memoryCharacters
